...
if (function_exists('wp_enqueue_media') && function_exists('wp_enqueue_script')) {
    ...
    wp_enqueue_script('smo-polling-client', SMO_SOCIAL_PLUGIN_URL . 'assets/js/smo-polling-client.js?v=' . $timestamp, ['jquery'], SMO_SOCIAL_VERSION, true);
    wp_enqueue_script('smo-chat-interface', SMO_SOCIAL_PLUGIN_URL . 'assets/js/smo-chat-interface.js?v=' . $timestamp, ['jquery', 'jquery-validate', 'wp-api', 'smo-polling-client'], SMO_SOCIAL_VERSION, true);
    ...
    if (function_exists('wp_localize_script') && function_exists('admin_url') && function_exists('wp_create_nonce') && function_exists('get_current_user_id')) {
        ...
        // Localize polling client config
        wp_localize_script('smo-polling-client', 'smoRealTimeConfig', [
            'enabled' => true,
