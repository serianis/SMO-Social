        ...
        <div class="smo-card">
            <div class="smo-card-header">
                ...
                <div class="smo-card-actions">
                    <div class="posts-filters-enhanced">
                        <input type="text" class="smo-form-input smo-input-medium" id="smo-search-posts"
                            placeholder="<?php esc_attr_e('Search posts...', 'smo-social'); ?>" />
                        <select class="smo-form-select smo-input-small" id="smo-status-filter">
                        ...
                        <select class="smo-form-select smo-input-small" id="smo-platform-filter">
