...
<div class="smo-card">
    <div class="smo-card-header">
        ...
        <div class="smo-card-actions">
            <select class="smo-form-select smo-input-medium" id="smo-category-filter">
    ...
    <div class="smo-card-body">
        <div class="smo-templates-grid-enhanced">
            ...
            <?php if (empty($templates)): ?>
                <div class="smo-empty-state smo-span-full">
...
<div id="smo-template-modal" class="smo-modal">
    <div class="smo-modal-content smo-modal-content-enhanced">
        ...
        <div class="smo-modal-body">
            <form id="smo-create-template-form">
                ...
                <div class="smo-form-actions">
                    <button type="submit" class="smo-btn smo-btn-primary smo-btn-full">
...
jQuery(document).ready(function($) {
    ...
    $('#smo-filter-popular').on('click', function() {
        // Sort by usage count
        const $grid = $('.smo-templates-grid-enhanced');
