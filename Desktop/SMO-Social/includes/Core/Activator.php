...
class Activator {
    public static function activate() {
        // Include required schema classes
        require_once dirname(__FILE__) . '/../Database/DatabaseSchema.php';
        require_once dirname(__FILE__) . '/../Database/IntegrationSchema.php';
    ...
    private static function create_tables() {
        ...
        $sql = "CREATE TABLE $branding_table (
        ...
        $sql = "CREATE TABLE $license_table (
            id bigint(20) NOT NULL AUTO_INCREMENT,
