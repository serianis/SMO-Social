...
class Notifications
{
    ...
    public function render()
    {
        ...
        <style>
        .smo-notifications-list {
            display: flex;
            flex-direction: column;
            gap: 12px;
        }

        .smo-notification-item {
            display: flex;
        ...
        .smo-notification-item.unread {
            background: rgba(102, 126, 234, 0.05);
            border-left: 4px solid var(--smo-primary);
        }

        .smo-notification-item:hover {
            box-shadow: var(--smo-shadow-md);
        }

        .smo-notification-icon {
            flex-shrink: 0;
            width: 40px;
            height: 40px;
            display: flex;
            ...
            background: var(--smo-primary-gradient);
            border-radius: var(--smo-radius-full);
            color: white;
            margin-right: 16px;
        }

        .smo-notification-icon .dashicons {
            font-size: 20px;
            width: 20px;
            height: 20px;
        }

        .smo-notification-content {
            flex: 1;
        }

        .smo-notification-content h4 {
            margin: 0 0 4px 0;
        ...
        .smo-notification-time {
            font-size: 12px;
            color: var(--smo-text-muted);
        }

        .smo-notification-actions {
            display: flex;
            gap: 8px;
            margin-left: 16px;
        }
