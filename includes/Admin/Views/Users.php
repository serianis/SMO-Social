...
?>
                            ...
                            <tbody>
                                <?php foreach ($users as $user): ?>
                                    <tr data-user-id="<?php echo esc_attr($user['ID']); ?>">
                                        <td>
                                            <div class="smo-user-info" style="display: flex; align-items: center; gap: 10px;">
                                                <img src="<?php echo esc_url($user['avatar']); ?>" alt="" class="smo-user-avatar" style="width: 32px; height: 32px; border-radius: 50%;">
                                        ...
                                        <td>
                                            <div class="smo-user-actions" style="display: flex; gap: 5px;">
    ...
    <div class="smo-tab-content" id="tab-channel-access" style="display: none;">
        <div class="smo-card">
            <div class="smo-card-header">
                <h2 class="smo-card-title">
                    <span class="dashicons dashicons-admin-network"></span>
            ...
            <div class="smo-card-body">
                ...
                <?php else: ?>
                    <div class="smo-channel-access-container">
                        ...
                        <div class="smo-actions-footer" style="margin-top: 20px; text-align: right;">
    ...
    <div class="smo-tab-content" id="tab-approval-workflows" style="display: none;">
        <div class="smo-card">
            <div class="smo-card-header">
                <h2 class="smo-card-title">
                    <span class="dashicons dashicons-yes-alt"></span>
    ...
    <!-- Invite User Modal -->
    <div id="smo-invite-modal" class="smo-modal" style="display: none;">
    ...
    <div id="smo-workflow-modal" class="smo-modal" style="display: none;">
        <div class="smo-modal-content">
            <div class="smo-modal-header">
            ...
            <div class="smo-modal-body">
                <form id="smo-workflow-form">
                    ...
                    <div class="smo-form-group">
                        ...
                        <input type="number" id="required_approvals" name="required_approvals" min="1" value="1" class="smo-form-input" style="width: 100px;">
                    </div>
                    <div class="smo-form-group">
                        <label class="smo-form-label"><?php _e('Select Approvers:', 'smo-social'); ?></label>
                        <div class="smo-approvers-list" style="max-height: 150px; overflow-y: auto; border: 1px solid var(--smo-border); padding: 10px; border-radius: var(--smo-radius-sm);">
                            <?php foreach ($users as $user): ?>
